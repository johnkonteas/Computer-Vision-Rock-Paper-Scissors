...
def _rock_paper_scissors_game():
    ...
    while True:
        ...
        cv2.putText(frame, 'Rock-Paper-Scissors Game', (90, 40), font, 1, blue, 2, cv2.LINE_AA)

        cv2.putText(frame, 'Press p to play', (5, 470), font, 1, blue, 1, cv2.LINE_AA)            

        cv2.putText(frame, 'Hold q to quit', (400, 470), font, 1, blue, 1, cv2.LINE_AA)
        ...
        if computer_score == 3:        
            ...
            cv2.putText(frame, 'Game Over', (55, 160), font, 3, blue, 9, cv2.LINE_AA)
            
            cv2.putText(frame, 'You Lose', (170, 320), font, 2, blue, 5, cv2.LINE_AA)
